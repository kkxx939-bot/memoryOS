"""Tenant-safe IndexStore test double backed by a process-local dictionary."""
...
from infrastructure.store.query import lexical_match_count, lexical_relevance, lexical_terms
