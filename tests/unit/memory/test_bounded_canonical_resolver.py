...
import memoryos.memory.integration.canonical_resolver as resolver_module
...
from memoryos.memory.integration.canonical_resolver import BoundedCanonicalResolver
