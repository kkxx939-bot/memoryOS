...
def test_placeholder_adapter_aliases_are_not_reported_as_production_ready(store_type: type) -> None:
    store = store_type()

    assert not vector_capabilities(store).production_filtered_top_k_ready
