"""Small query-filter helpers shared by Catalog readers."""

from __future__ import annotations

from memoryos.adapters.persistence.sqlite._common import Any, Mapping


class QueryFilterBuilder:
    """Compile exact metadata and relation predicates without tenant-free joins."""
