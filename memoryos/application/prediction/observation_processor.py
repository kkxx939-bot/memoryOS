"""Application orchestration for predictive observation processing."""
...
class PredictiveObservationProcessor:
    """Process a prediction and optionally archive its session."""
...
__all__ = ["PredictiveObservationProcessor"]
