"""Immutable event envelopes derived from a SessionArchive."""
...
from memoryos.core.integrity.canonical_json import immutable_snapshot
from memoryos.memory.evidence.scope import ScopeRef
...
class EventEnvelope:
    ...
    def text(self) -> str:
        if isinstance(self.content, Mapping):
            for key in ("content", "text", "raw_text", "result", "output"):
