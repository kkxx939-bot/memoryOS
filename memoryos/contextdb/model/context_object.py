    ...
    def from_dict(cls, payload: dict) -> ContextObject:
        ...
        relations = [
            ContextRelation(
                ...
                # Relation timestamps are audit data, not read-time data.  A
                # missing legacy timestamp stays the stable empty value rather
                # than being regenerated by ContextRelation.default_factory.
