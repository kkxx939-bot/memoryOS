...
class RuleMemoryCommitPlanner:
    ...
    def __init__(
        ...
        self.archive_store = SessionArchiveStore(root, tenant_id=tenant_id) if root is not None else None
    ...
    def bind_runtime_stores(
        ...
        *,
        ...
        archive_store = SessionArchiveStore(root, tenant_id=tenant_id)
        ...
        if self.archive_store is not None and (
            self.archive_store.root.resolve() != archive_store.root.resolve()
            or self.archive_store.tenant_id != archive_store.tenant_id
        ):
