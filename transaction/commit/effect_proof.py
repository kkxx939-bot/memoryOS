"""已提交 SourceStore 与 RelationStore 副作用的耐久校验证明。"""
...
EFFECT_MARKER_SCHEMA_VERSION = "effect_marker_v2"


class EffectProofError(RuntimeError):
    """耐久标记无法证明其声明的 SourceStore 副作用。"""
...
def build_marker(
    *,
    ...
    core: dict[str, Any] = {
        ...
        "diff_id": diff_id,
        "operation_fingerprints": dict(operation_fingerprints),
    }
