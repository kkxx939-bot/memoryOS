...
from memory.core.model import ManagedDocument, ScanGeneration
    ...
    def scan(
        ...
        *,
        ...
        if missing_durable_identity:
            # 没有耐久 inode 基线时，无法安全区分原目录树和逐字节替换后的目录树。
            # 因此保持当前扫描器阻塞，直到操作者恢复耐久产物并重启恢复流程。
