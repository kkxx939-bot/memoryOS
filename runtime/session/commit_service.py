...
from infrastructure.store.runtime_layout import tenant_runtime_root
...
from runtime.session.commit_entry import commit_session as commit_session_entry
from runtime.session.commit_model import (
    SessionCommitResult,
    SessionCommitState,
)
from runtime.session.commit_support import _SessionCommitSupport
...
class SessionCommitService(_SessionCommitSupport):
    ...
    def __init__(
        ...
        expected_control_root = tenant_runtime_root(archive_store.root, archive_store.tenant_id)
