...
from foundation.identity import LOCAL_STORAGE_NAMESPACE, require_internal_job_namespace
from infrastructure.store.contracts.queue import QueueJob, QueueStore
from infrastructure.store.memory.scanner import MemoryDocumentScanner
...
class MemoryDocumentScanWorker:
    ...
    def __init__(
        ...
        *,
        ...
        self.storage_namespace = LOCAL_STORAGE_NAMESPACE
    ...
    def _validate_job(self, job: QueueJob) -> str:
        ...
        require_internal_job_namespace(job.payload)
    ...
    def _scan_owner(self, owner_user_id: str, *, notified: bool) -> Any:
        if notified:
            self.scanner.notify(self.storage_namespace, owner_user_id)
