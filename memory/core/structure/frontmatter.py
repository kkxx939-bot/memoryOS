...
def matches_adopted_source(raw: bytes, document_id: str, expected_raw_sha256: str) -> bool:
    """验证受管字节恰好来自一次已知源摘要的接管。

    这里只逆向检查 :func:`adopt_raw_document` 执行的两种精确字节插入，
    耐久接管凭证不需要保留任何源正文。
    """
