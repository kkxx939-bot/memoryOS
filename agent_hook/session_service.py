"""Agent 实时会话的追加式日志、Transcript 游标同步与崩溃恢复。"""
...
from agent_hook.events import AgentEventType, NormalizedAgentEvent
...
from sanitization import sanitize_error_text, sanitize_payload
